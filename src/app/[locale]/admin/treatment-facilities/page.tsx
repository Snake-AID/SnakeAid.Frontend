...
import { Building2, MapPin, Pencil, Plus, RefreshCcw, ShieldCheck, Trash2 } from 'lucide-react';
                  ...
                  <div className="flex flex-wrap items-start justify-between gap-3">
                    <div className="flex min-w-0 items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="mt-1 text-sm text-slate-500">{selectedDetail.contactNumber}</p>
                      </div>
                    </div>
